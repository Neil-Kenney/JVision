...
EAR_THRESHOLD = 0.10
DROWSY_FRAMES = 100  # tune: ~100 frames
drowsy_counter = 0
...
while True:
    ...
    # ============================================================
    # BREAK POPUP TRIGGER (DROWSINESS via EAR)
    # ============================================================
    if face_present and not break_active and mesh_results.multi_face_landmarks:
        for face_landmarks in mesh_results.multi_face_landmarks:
            ...
            # Optional debug draw
            cv2.putText(to_display, f"EAR: {ear:.2f}", (30, 70),
            ...
            if drowsy_counter > DROWSY_FRAMES and not break_active:
                cv2.putText(to_display, "DROWSY!", (30, 150),
                            cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 0, 255), 3)
                break_active = True
                # Reset away timer so the break screen doesn't instantly dismiss
